    ...
    <div class="container">
        <div class="col-md-8 col-md-offset-2">
            <div class="row">
                ...
                <br>
                <div class="col-md-4">
                    <a href="/users" style="text-decoration: none"><span class="glyphicon glyphicon-user"
                                           style="display: block; text-align: center; font-size: 200px"
                                           aria-hidden="true"></span></a>
                    <a href="/users"><h3 style="text-align: center">Users</h3></a>
                </div>
                <div class="col-md-4">
                    <a href="/teams" style="text-decoration: none"><span class="glyphicon glyphicon-link"
                                           style="display: block; text-align: center; font-size: 200px"
                                           aria-hidden="true"></span></a>
                    <a href="/teams"><h3 style="text-align: center">Teams</h3></a>
                </div>
                <div class="col-md-4">
                    <a href="/scrims" style="text-decoration: none"><span class="glyphicon glyphicon-knight"
                                            style="display: block; text-align: center; font-size: 200px"
                                            aria-hidden="true"></span></a>
